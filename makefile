...
cross-gvsbuild : LDFLAGS=-Lgvsbuild/lib -lgtk-4 -lharfbuzz -lpangocairo-1.0 -lpango-1.0 -lgdk_pixbuf-2.0 -lcairo-gobject -lcairo -lgraphene-1.0 -lgio-2.0 -lglib-2.0 -lgobject-2.0
...
clean:
	rm -f $(OBJS) $(OUTNAME) gvsbuild-$(OUTNAME)
